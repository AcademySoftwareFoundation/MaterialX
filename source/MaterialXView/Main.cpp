...
"    --bakeWidth [INTEGER]          Specify the width of the baked image in pixels (defaults to computed max resolution)\n"
"    --bakeHeight [INTEGER]         Specify the height of the baked image in pixels (defaults to computed max resolution)\n"
"    --bakeFilename [STRING]        Specify the filename to which the output file should be written\n"
