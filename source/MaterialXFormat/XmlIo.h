...
struct MX_FORMAT_API TemplateArgs
{
    StringVec varNameVec;
    std::vector<StringVec> optionsVec;
};

MX_FORMAT_API TemplateArgs parseTemplateArgs(const string& varNamesAttr, const string& optionsAttr);
