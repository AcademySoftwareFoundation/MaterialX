...
void bindPyMesh(py::module& mod)
{
    py::class_<mx::MeshStream, mx::MeshStreamPtr>(mod, "MeshStream")
        ...
        .def_property_readonly_static("STRIDE_2D", [](py::object){return mx::MeshStream::STRIDE_2D;})
        .def_property_readonly_static("STRIDE_3D", [](py::object){return mx::MeshStream::STRIDE_3D;})
        .def_property_readonly_static("DEFAULT_STRIDE", [](py::object){return mx::MeshStream::DEFAULT_STRIDE;})
