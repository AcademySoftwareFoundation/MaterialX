...
void bindPyMesh(py::module& mod)
{
    ...
    py::class_<mx::Mesh, mx::MeshPtr>(mod, "Mesh")
        ...
        .def("getStream", static_cast<mx::MeshStreamPtr (mx::Mesh::*)(const std::string&, bool)> (&mx::Mesh::getStream))
        .def("getStream", static_cast<mx::MeshStreamPtr (mx::Mesh::*)(const std::string&, unsigned int, bool)> (&mx::Mesh::getStream))
