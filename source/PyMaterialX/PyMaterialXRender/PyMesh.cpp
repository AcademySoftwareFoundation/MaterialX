...
void bindPyMesh(py::module& mod)
{
    py::class_<mx::MeshStream, mx::MeshStreamPtr>(mod, "MeshStream", "Class to represent a mesh data stream.")
        ...
        .def_static("create", &mx::MeshStream::create, "Create a new mesh stream.")
        ...
        .def("resize", &mx::MeshStream::resize, "Resize data to an given number of elements.")
        .def("getName", &mx::MeshStream::getName, "Get stream name.")
        .def("getType", &mx::MeshStream::getType, "Get stream attribute name.")
        .def("getIndex", &mx::MeshStream::getIndex, "Get stream index.")
    ...
    py::class_<mx::MeshPartition, mx::MeshPartitionPtr>(mod, "MeshPartition", "Class that describes a sub-region of a mesh using vertex indexing.\n\nNote that a face is considered to be a triangle.")
        .def_static("create", &mx::MeshPartition::create, "Create a new mesh partition.")
        .def(py::init<>())
        .def("resize", &mx::MeshPartition::resize, "Resize data to the given number of indices.")
        .def("setName", &mx::MeshPartition::setName, "Set the name of this partition.")
        .def("getName", &mx::MeshPartition::getName, "Return the name of this partition.")
    ...
    py::class_<mx::Mesh, mx::MeshPtr>(mod, "Mesh", "Container for mesh data.")
        .def_static("create", &mx::Mesh::create, "Create a new mesh.")
        .def(py::init<const std::string&>())
        .def("getName", &mx::Mesh::getName, "Return the name of this mesh.")
        .def("setSourceUri", &mx::Mesh::setSourceUri, "Set the mesh's source URI.")
        .def("hasSourceUri", &mx::Mesh::hasSourceUri, "Return true if this mesh has a source URI.")
        .def("getSourceUri", &mx::Mesh::getSourceUri, "Return the mesh's source URI.")
        ...
        .def("getMinimumBounds", &mx::Mesh::getMinimumBounds, "Return the minimum bounds for the geometry.")
        .def("setMaximumBounds", &mx::Mesh::setMaximumBounds, "Set the minimum bounds for the geometry.")
        .def("getMaximumBounds", &mx::Mesh::getMaximumBounds, "Return the minimum bounds for the geometry.")
