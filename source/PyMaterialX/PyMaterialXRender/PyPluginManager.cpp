...
void bindPyPluginManager(py::module& mod)
{
    ...
    }, py::arg("loader"));    mod.def("unregisterDocumentLoader", [](const std::string& identifier) -> bool {
    ...
    mod.def("setRegistrationCallback", [](py::function callback) {
        mx::PluginManager::getInstance().setRegistrationCallback([callback](const std::string& id, bool registered) {
