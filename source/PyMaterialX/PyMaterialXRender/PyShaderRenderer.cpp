...
void bindPyShaderRenderer(py::module& mod)
{
    py::class_<mx::ShaderRenderer, mx::ShaderRendererPtr>(mod, "ShaderRenderer", "Base class for renderers that generate shader code to produce images.")
        .def("initialize", &mx::ShaderRenderer::initialize, py::arg("renderContextHandle") = nullptr, "Initialize with the given implementation element.\n\nInitialization must set the name and hash for the implementation, as well as any other data needed to emit code for the node.")
        ...
        .def("createProgram", static_cast<void (mx::ShaderRenderer::*)(mx::ShaderPtr)>(&mx::ShaderRenderer::createProgram), "Create GLSL program based on shader stage source code.\n\nArgs:\n    stages: Map of name and source code for the shader stages.")
        .def("createProgram", static_cast<void (mx::ShaderRenderer::*)(const mx::ShaderRenderer::StageMap&)>(&mx::ShaderRenderer::createProgram), "Create GLSL program based on shader stage source code.\n\nArgs:\n    stages: Map of name and source code for the shader stages.")
        ...
        .def("render", &mx::ShaderRenderer::render, "Render the current program to an offscreen buffer.");
