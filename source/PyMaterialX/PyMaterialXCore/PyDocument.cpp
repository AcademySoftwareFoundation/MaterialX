...
void bindPyDocument(py::module& mod)
{
    ...
    py::class_<mx::Document, mx::DocumentPtr, mx::GraphElement>(mod, "Document", "A MaterialX document, which represents the top-level element in the MaterialX ownership hierarchy.\n\nUse the factory function createDocument() to create a Document instance.")
        .def("initialize", &mx::Document::initialize, "Initialize the document, removing any existing content.")
        .def("copy", &mx::Document::copy, "Create a deep copy of the document.")
        ...
        .def("getGeomPropValue", &mx::Document::getGeomPropValue, py::arg("geomPropName"), py::arg("geom") = mx::UNIVERSAL_GEOM_NAME, "Return the value of a geometric property for the given geometry string.")
        ...
        .def("getNodeDef", &mx::Document::getNodeDef, "Return the NodeDef, if any, with the given name.")
