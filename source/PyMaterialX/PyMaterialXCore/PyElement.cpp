...
void bindPyElement(py::module& mod)
{
    py::class_<mx::Element, mx::ElementPtr>(mod, "Element", "The base class for MaterialX elements.\n\nAn Element is a named object within a Document, which may possess any number of child elements and attributes.")
        ...
        .def("getName", &mx::Element::getName, "Return the element's name string.")
        .def("getNamePath", &mx::Element::getNamePath, py::arg("relativeTo") = nullptr, "Return the element's hierarchical name path, relative to the root document.\n\nArgs:\n    relativeTo: If a valid ancestor element is specified, then the returned path will be relative to this ancestor.")
        ...
        .def("getSelf", static_cast<mx::ElementPtr (mx::Element::*)()>(&mx::Element::getSelf), "Return a shared pointer instance of this object.")
        .def("getParent", static_cast<mx::ElementPtr(mx::Element::*)()>(&mx::Element::getParent), "Return the parent graph that owns this node.\n\nIf this node is a root graph it has no parent and nullptr will be returned.")
        .def("getRoot", static_cast<mx::ElementPtr(mx::Element::*)()>(&mx::Element::getRoot), "Return the root element of our tree.")
        .def("getDocument", static_cast<mx::DocumentPtr(mx::Element::*)()>(&mx::Element::getDocument), "Return the document associated with this ShaderMaterial.")
    ...
    py::class_<mx::TypedElement, mx::TypedElementPtr, mx::Element>(mod, "TypedElement", "The base class for typed elements.")
        .def("setType", &mx::TypedElement::setType, "Set the element's type string.")
        .def("hasType", &mx::TypedElement::hasType, "Return true if the given element has a type string.")
        .def("getType", &mx::TypedElement::getType, "Return the element's type string.")
        ...
        .def("getTypeDef", &mx::TypedElement::getTypeDef, "Return the TypeDef declaring the type string of this element.\n\nIf no matching TypeDef is found, then an empty shared pointer is returned.")
    ...
    py::class_<mx::ValueElement, mx::ValueElementPtr, mx::TypedElement>(mod, "ValueElement", "The base class for elements that support typed values.")
        ...
        .def("getValueString", &mx::ValueElement::getValueString, "Get the value string of a element.")
        .def("getResolvedValueString", &mx::ValueElement::getResolvedValueString, py::arg("resolver") = nullptr, "Return the resolved value string of an element, applying any string substitutions that are defined at the element's scope.\n\nArgs:\n    resolver: An optional string resolver, which will be used to apply string substitutions. By default, a new string resolver will be created at this scope and applied to the return value.")
        ...
        .def("_getValue", &mx::ValueElement::getValue, "Return the typed value of an element as a generic value object, which may be queried to access its data.\n\nReturns:\n    A shared pointer to the typed value of this element, or an empty shared pointer if no value is present.")
        .def("_getDefaultValue", &mx::ValueElement::getDefaultValue, "Return the default value for this element as a generic value object, which may be queried to access its data.\n\nReturns:\n    A shared pointer to a typed value, or an empty shared pointer if no default value was found.")
        .def("setUnit", &mx::ValueElement::setUnit, "Set the unit string of an element.")
        .def("hasUnit", &mx::ValueElement::hasUnit, "Return true if the given element has a unit string.")
        .def("getUnit", &mx::ValueElement::getUnit, "Return the unit string of an element.")
        ...
        .def("setUnitType", &mx::ValueElement::setUnitType, "Set the unit type of an element.")
        .def("hasUnitType", &mx::ValueElement::hasUnitType, "Return true if the given element has a unit type.")
        .def("getUnitType", &mx::ValueElement::getUnitType, "Return the unit type of an element.")
    ...
    py::class_<mx::StringResolver, mx::StringResolverPtr>(mod, "StringResolver", "A helper object for applying string modifiers to data values in the context of a specific element and geometry.\n\nA StringResolver may be constructed through the Element::createStringResolver method, which initializes it in the context of a specific element, geometry, and material.\n\nCalling the StringResolver::resolve method applies all modifiers to a particular string value.\n\nMethods such as StringResolver::setFilePrefix may be used to edit the stored string modifiers before calling StringResolver::resolve.")
        .def("setFilePrefix", &mx::StringResolver::setFilePrefix, "Set the file prefix for this context.")
        .def("getFilePrefix", &mx::StringResolver::getFilePrefix, "Return the file prefix for this context.")
        .def("setGeomPrefix", &mx::StringResolver::setGeomPrefix, "Set the geom prefix for this context.")
        .def("getGeomPrefix", &mx::StringResolver::getGeomPrefix, "Return the geom prefix for this context.")
    ...
    mod.def("targetStringsMatch", &mx::targetStringsMatch, "Given two target strings, each containing a string array of target names, return true if they have any targets in common.\n\nAn empty target string matches all targets.");
    mod.def("prettyPrint", &mx::prettyPrint, "Pretty print the given element tree, calling asString recursively on each element in depth-first order.");
}
