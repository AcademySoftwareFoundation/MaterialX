...
void bindPyNode(py::module& mod)
{
    ...
    py::class_<mx::Node, mx::NodePtr, mx::InterfaceElement>(mod, "Node", "A node element within a NodeGraph or Document.\n\nA Node represents an instance of a NodeDef within a graph, and its Input elements apply specific values and connections to that instance.")
        ...
        .def("getConnectedNode", &mx::Node::getConnectedNode, "Return the node, if any, to which this input is connected.")
        ...
        .def("getNodeDef", &mx::Node::getNodeDef,
            py::arg("target") = mx::EMPTY_STRING, py::arg("allowRoughMatch") = false, "Returns a nodedef for a given transform.")
    ...
    py::class_<mx::GraphElement, mx::GraphElementPtr, mx::InterfaceElement>(mod, "GraphElement", "The base class for graph elements such as NodeGraph and Document.")
        ...
        .def("addMaterialNode", &mx::GraphElement::addMaterialNode,
            py::arg("name") = mx::EMPTY_STRING, py::arg("shaderNode") = nullptr, "Add a material node to the graph, optionally connecting it to the given shader node.")
        ...
        .def("addBackdrop", &mx::GraphElement::addBackdrop,
            py::arg("name") = mx::EMPTY_STRING, "Add a Backdrop to the graph.")
    ...
    py::class_<mx::NodeGraph, mx::NodeGraphPtr, mx::GraphElement>(mod, "NodeGraph", "A node graph element within a Document.")
        .def("getMaterialOutputs", &mx::NodeGraph::getMaterialOutputs, "Return material-type outputs for all nodegraphs in the document.")        
        .def("setNodeDef", &mx::NodeGraph::setNodeDef, "Set the NodeDef element referenced by the Implementation.")
        .def("getNodeDef", &mx::NodeGraph::getNodeDef, "Returns a nodedef for a given transform.")
        ...
        .def("getDownstreamPorts", &mx::NodeGraph::getDownstreamPorts, "Return a vector of all downstream ports that connect to this node, ordered by the names of the port elements.")
