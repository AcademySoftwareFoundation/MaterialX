...
void bindPyDefinition(py::module& mod)
{
    py::class_<mx::NodeDef, mx::NodeDefPtr, mx::InterfaceElement>(mod, "NodeDef", "A node definition element within a Document.\n\nA NodeDef provides the declaration of a node interface, which may then be instantiated as a Node.")
        ...
        .def("getImplementation", &mx::NodeDef::getImplementation, "Return the first implementation for this nodedef, optionally filtered by the given target name.\n\nArgs:\n    target: An optional target name, which will be used to filter the implementations that are considered.\n\nReturns:\n    An implementation for this nodedef, or an empty shared pointer if none was found. Note that a node implementation may be either an Implementation element or a NodeGraph element.")
        .def("getImplementation", &mx::NodeDef::getImplementation, py::arg("target") = mx::EMPTY_STRING, "Return the first implementation for this nodedef, optionally filtered by the given target name.\n\nArgs:\n    target: An optional target name, which will be used to filter the implementations that are considered.\n\nReturns:\n    An implementation for this nodedef, or an empty shared pointer if none was found. Note that a node implementation may be either an Implementation element or a NodeGraph element.")
    ...
    py::class_<mx::Implementation, mx::ImplementationPtr, mx::InterfaceElement>(mod, "Implementation", "An implementation element within a Document.\n\nAn Implementation is used to associate external source code with a specific NodeDef, providing a definition for the node that may either be universal or restricted to a specific target.")
        ...
        .def("getNodeDef", &mx::Implementation::getNodeDef, "Return the NodeDef element referenced by the Implementation.")
        ...
        .def("getNodeGraph", &mx::Implementation::getNodeGraph, "Return the nodegraph string for the Implementation.")
    ...
    py::class_<mx::TypeDef, mx::TypeDefPtr, mx::Element>(mod, "TypeDef", "A type definition element within a Document.")
        .def("setSemantic", &mx::TypeDef::setSemantic, "Set the semantic string of the TypeDef.")
        .def("hasSemantic", &mx::TypeDef::hasSemantic, "Return true if the given TypeDef has a semantic string.")
        .def("getSemantic", &mx::TypeDef::getSemantic, "Return the semantic string of the TypeDef.")
    ...
    py::class_<mx::UnitDef, mx::UnitDefPtr, mx::Element>(mod, "UnitDef", "A unit definition element within a Document.")
        ...
        .def("getUnitType", &mx::UnitDef::getUnitType, "Return the element's type string.")
        ...
        .def("getUnit", &mx::UnitDef::getUnit, "Return the Unit, if any, with the given name.")
    ...
    py::class_<mx::UnitTypeDef, mx::UnitTypeDefPtr, mx::Element>(mod, "UnitTypeDef", "A unit type definition element within a Document.")
        .def("getUnitDefs", &mx::UnitTypeDef::getUnitDefs, "Find all UnitDefs for the UnitTypeDef.")
    ...
    py::class_<mx::AttributeDef, mx::AttributeDefPtr, mx::TypedElement>(mod, "AttributeDef", "An attribute definition element within a Document.")
        ...
        .def("getValueString", &mx::AttributeDef::getValueString, "Get the value string of a element.") 
