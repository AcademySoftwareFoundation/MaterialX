...
using py::return_value_policy::reference_internal;
...
.def(-py::self)                                                                       \
.def(+py::self)                                                                       \
.def("__iadd__", (&V::operator+=), reference_internal)                                \
.def(py::self - py::self)                                                             \
.def("__isub__", (&V::operator-=), reference_internal)                                \
.def(py::self * py::self)                                                             \
.def("__imul__", py::overload_cast<const V&>(&V::operator*=), reference_internal)     \
.def("__imul__", py::overload_cast<float>(&V::operator*=), reference_internal)        \
.def(py::self / py::self)                                                             \
.def("__itruediv__", py::overload_cast<const V&>(&V::operator/=), reference_internal) \
.def("__itruediv__", py::overload_cast<float>(&V::operator/=), reference_internal)    \
.def(py::self * float())                                                              \
.def(py::self / float())                                                              \
...
.def(-py::self)                                                                       \
.def(+py::self)                                                                       \
.def("__iadd__", (&M::operator+=), reference_internal)                                \
.def(py::self - py::self)                                                             \
.def("__isub__", (&M::operator-=), reference_internal)                                \
.def(py::self * py::self)                                                             \
.def("__imul__", py::overload_cast<float>(&M::operator*=), reference_internal)        \
.def("__imul__", py::overload_cast<const M&>(&M::operator*=), reference_internal)     \
.def(py::self / py::self)                                                             \
.def("__itruediv__", py::overload_cast<float>(&M::operator/=), reference_internal)    \
.def("__itruediv__", py::overload_cast<const M&>(&M::operator/=), reference_internal) \
.def(py::self * float())                                                              \
.def(py::self / float())                                                              \
