...
void bindPyDocument(py::module& mod)
{
    ...
    py::class_<mx::Document, mx::DocumentPtr, mx::Element>(mod, "Document")
        ...
        .def("importLibrary", &mx::Document::importLibrary, py::arg("library"), py::arg("copyOptions") = (mx::CopyOptions*) nullptr)
        ...
        .def("getPublicElement", &mx::Document::getPublicElement)
        .def("getPublicElements", &mx::Document::getPublicElements)
        .def("setRequireString", &mx::Document::setRequireString)
        .def("hasRequireString", &mx::Document::hasRequireString)
        .def("getRequireString", &mx::Document::getRequireString)
        .def("generateRequireString", &mx::Document::generateRequireString)
