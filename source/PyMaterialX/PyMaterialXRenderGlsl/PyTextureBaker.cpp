...
void bindPyTextureBaker(py::module& mod)
{
    py::class_<mx::TextureBakerGlsl, mx::GlslRenderer, mx::TextureBakerPtr>(mod, "TextureBaker", "A helper class for baking procedural material content to textures.\n\nTODO: Add support for graphs containing geometric nodes such as position and normal.")
        ...
        .def("getExtension", &mx::TextureBakerGlsl::getExtension, "Return the file extension of the given path.")
        .def("setColorSpace", &mx::TextureBakerGlsl::setColorSpace, "Set the element's color space string.")
        .def("getColorSpace", &mx::TextureBakerGlsl::getColorSpace, "Return the element's color space string.")
