...
void bindPyGlslProgram(py::module& mod)
{
    py::class_<mx::GlslProgram, mx::GlslProgramPtr>(mod, "GlslProgram", "A class representing an executable GLSL program.\n\nThere are two main interfaces which can be used. One which takes in a HwShader and one which allows for explicit setting of shader stage code.")
        ...
        .def("bindPartition", &mx::GlslProgram::bindPartition, "Bind a mesh partition to this material.")
        .def("bindMesh", &mx::GlslProgram::bindMesh, "Bind the given mesh to this material.")
        .def("unbindGeometry", &mx::GlslProgram::unbindGeometry, "Unbind all geometry from this material.")
        .def("bindTextures", &mx::GlslProgram::bindTextures, "Bind any input textures.")
        .def("bindLighting", &mx::GlslProgram::bindLighting, "Bind lights to shader.")
        .def("bindViewInformation", &mx::GlslProgram::bindViewInformation, "Bind viewing information for this material.")
        .def("bindTimeAndFrame", &mx::GlslProgram::bindTimeAndFrame,
            py::arg("time") = 0.0f, py::arg("frame") = 1.0f, "Bind time and frame.")
