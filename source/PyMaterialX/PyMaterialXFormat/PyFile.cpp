...
void bindPyFile(py::module& mod)
{
    ...
    py::class_<mx::FilePath>(mod, "FilePath", "A generic file path, supporting both syntactic and file system operations.")
        ...
        .def("asString", &mx::FilePath::asString,
             py::arg("format") = mx::FilePath::Format::FormatNative, "Return a single-line description of this element, including its category, name, and attributes.")
    ...
    py::class_<mx::FileSearchPath>(mod, "FileSearchPath", "A sequence of file paths, which may be queried to find the first instance of a given filename on the file system.")
        ...
        .def("asString", &mx::FileSearchPath::asString,
             py::arg("sep") = mx::PATH_LIST_SEPARATOR, "Return a single-line description of this element, including its category, name, and attributes.")
        ...
        .def("size", &mx::FileSearchPath::size, "Return the number of strings in the path.")
        .def("isEmpty", &mx::FileSearchPath::isEmpty, "Return true if the given path is empty.")
