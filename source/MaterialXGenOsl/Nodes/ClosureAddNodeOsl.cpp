...
const string ClosureAddNodeOsl::IN1 = "in1";
const string ClosureAddNodeOsl::IN2 = "in2";

ShaderNodeImplPtr ClosureAddNodeOsl::create()
{
    return std::make_shared<ClosureAddNodeOsl>();
}

void ClosureAddNodeOsl::emitFunctionCall(const ShaderNode& _node, GenContext& context, ShaderStage& stage) const
{
