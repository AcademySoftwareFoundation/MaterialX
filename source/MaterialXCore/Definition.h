...
class MX_CORE_API NodeDef : public InterfaceElement
{
  public:
    ...
    /// @param graphIndirect Allow indirection from Implementation elements
    ...
    InterfaceElementPtr getImplementation(const string& target = EMPTY_STRING, bool graphIndirect = true) const;
