...
class MX_CORE_API UnitConverter
{
  public:
    ...
    /// Returns an empty string if index not found.
...
class MX_CORE_API LinearUnitConverter : public UnitConverter
{
  public:
    ...
    /// Creator
    static LinearUnitConverterPtr create(UnitTypeDefPtr unitTypeDef);
...
class MX_CORE_API UnitConverterRegistry
{
  public:
    ...
    /// Returns an empty pointer if a converter does not exist for the given UnitTypeDef.
