...
ShaderNodeImplPtr GeomColorNodeImplGlsl::create()
{
    return std::make_shared<GeomColorNodeImplGlsl>();
}

void GeomColorNodeImplGlsl::createVariables(const ShaderNode& node, ShaderGenerator& /*shadergen*/, Shader& shader_)
{
...
void GeomColorNodeImplGlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderGenerator& shadergen, Shader& shader_)
{
    HwShader& shader = static_cast<HwShader&>(shader_);
