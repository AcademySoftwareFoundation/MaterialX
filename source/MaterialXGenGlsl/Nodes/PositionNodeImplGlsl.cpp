...
ShaderNodeImplPtr PositionNodeImplGlsl::create()
{
    return std::make_shared<PositionNodeImplGlsl>();
}

void PositionNodeImplGlsl::createVariables(const ShaderNode& node, ShaderGenerator& /*shadergen*/, Shader& shader_)
{
...
void PositionNodeImplGlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderGenerator& shadergen, Shader& shader_)
{
    HwShader& shader = static_cast<HwShader&>(shader_);
