...
ShaderNodeImplPtr NormalNodeImplGlsl::create()
{
    return std::make_shared<NormalNodeImplGlsl>();
}

void NormalNodeImplGlsl::createVariables(const ShaderNode& node, ShaderGenerator& /*shadergen*/, Shader& shader_)
{
...
void NormalNodeImplGlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderGenerator& shadergen, Shader& shader_)
{
    HwShader& shader = static_cast<HwShader&>(shader_);
