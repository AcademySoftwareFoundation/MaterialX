...
GenImplementationPtr LightShaderGlsl::create()
{
...
void LightShaderGlsl::createVariables(const DagNode& /*node*/, ShaderGenerator& /*shadergen*/, Shader& shader_)
{
...
void LightShaderGlsl::emitFunctionCall(const DagNode& /*node*/, GenContext& /*context*/, ShaderGenerator& /*shadergen*/, Shader& shader_)
{
    HwShader& shader = static_cast<HwShader&>(shader_);
