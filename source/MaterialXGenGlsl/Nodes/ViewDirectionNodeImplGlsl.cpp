...
ShaderNodeImplPtr ViewDirectionNodeImplGlsl::create()
{
    return std::make_shared<ViewDirectionNodeImplGlsl>();
}

void ViewDirectionNodeImplGlsl::createVariables(const ShaderNode& /*node*/, ShaderGenerator& /*shadergen*/, Shader& shader_)
{
...
void ViewDirectionNodeImplGlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderGenerator& shadergen, Shader& shader_)
{
    HwShader& shader = static_cast<HwShader&>(shader_);
