...
ShaderNodeImplPtr LightShaderNodeImplGlsl::create()
{
    return std::make_shared<LightShaderNodeImplGlsl>();
}

const string& LightShaderNodeImplGlsl::getLanguage() const
{
    return GlslShaderGenerator::LANGUAGE;
}

const string& LightShaderNodeImplGlsl::getTarget() const
{
    return GlslShaderGenerator::TARGET;
}

void LightShaderNodeImplGlsl::initialize(ElementPtr implementation, ShaderGenerator& shadergen)
{
    SourceCodeNodeImpl::initialize(implementation, shadergen);
...
void LightShaderNodeImplGlsl::createVariables(const ShaderNode& /*node*/, ShaderGenerator& /*shadergen*/, Shader& shader_)
{
...
void LightShaderNodeImplGlsl::emitFunctionCall(const ShaderNode& /*node*/, GenContext& /*context*/, ShaderGenerator& /*shadergen*/, Shader& shader_)
{
    HwShader& shader = static_cast<HwShader&>(shader_);
