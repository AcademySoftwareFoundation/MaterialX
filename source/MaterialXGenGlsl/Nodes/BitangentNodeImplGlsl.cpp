...
ShaderNodeImplPtr BitangentNodeImplGlsl::create()
{
    return std::make_shared<BitangentNodeImplGlsl>();
}

void BitangentNodeImplGlsl::createVariables(const ShaderNode& node, ShaderGenerator& /*shadergen*/, Shader& shader_)
{
...
void BitangentNodeImplGlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderGenerator& shadergen, Shader& shader_)
{
    HwShader& shader = static_cast<HwShader&>(shader_);
