...
ShaderNodeImplPtr TangentNodeImplGlsl::create()
{
    return std::make_shared<TangentNodeImplGlsl>();
}

void TangentNodeImplGlsl::createVariables(const ShaderNode& node, ShaderGenerator& /*shadergen*/, Shader& shader_)
{
...
void TangentNodeImplGlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderGenerator& shadergen, Shader& shader_)
{
    HwShader& shader = static_cast<HwShader&>(shader_);
