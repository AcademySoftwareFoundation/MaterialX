...
ShaderNodeImplPtr BsdfSourceCodeNodeGlsl::create()
{
    return std::make_shared<BsdfSourceCodeNodeGlsl>();
}

void BsdfSourceCodeNodeGlsl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderStage& stage) const
{
