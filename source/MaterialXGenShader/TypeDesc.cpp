...
namespace Type
{
    ...
    const TypeDesc* FLOATARRAY         = TypeDesc::registerType("floatarray", TypeDesc::BASETYPE_FLOAT, TypeDesc::SEMATIC_NONE, 0);
    ...
    const TypeDesc* COLOR2             = TypeDesc::registerType("color2", TypeDesc::BASETYPE_FLOAT, TypeDesc::SEMATIC_COLOR, 2, true, {{'r', 0}, {'g', 1}});
