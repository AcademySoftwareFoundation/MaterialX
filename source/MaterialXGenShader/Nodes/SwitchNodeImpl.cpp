...
const vector<string> SwitchNodeImpl::INPUT_NAMES = { "in1", "in2", "in3", "in4", "in5", "which" };

ShaderNodeImplPtr SwitchNodeImpl::create()
{
    return std::make_shared<SwitchNodeImpl>();
}

void SwitchNodeImpl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderGenerator& shadergen, Shader& shader)
{
