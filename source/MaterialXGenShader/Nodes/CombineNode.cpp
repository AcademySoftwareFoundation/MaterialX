...
void CombineNode::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderGenerator& shadergen, Shader& shader)
{
    ...
    else if (in1->type == Type::COLOR3 || in1->type == Type::VECTOR3)
    {
        ...
        if (!in1->connection)
        {
            ...
            shader.addLine(shadergen.getSyntax()->getTypeName(in1->type) + " " + in1Variable + " = " + variableValue);
        }
    ...
    else if (in1->type == Type::COLOR2 || in1->type == Type::VECTOR2)
    {
        ...
        if (!in2->connection)
        {
            ...
            shader.addLine(shadergen.getSyntax()->getTypeName(in2->type) + " " + in2Variable + " = " + variableValue);
        }
