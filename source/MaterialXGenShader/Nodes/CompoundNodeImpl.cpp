...
ShaderNodeImplPtr CompoundNodeImpl::create()
{
    return std::make_shared<CompoundNodeImpl>();
}

void CompoundNodeImpl::initialize(ElementPtr implementation, ShaderGenerator& shadergen)
{
...
void CompoundNodeImpl::createVariables(const ShaderNode& /*node*/, ShaderGenerator& shadergen, Shader& shader)
{
...
void CompoundNodeImpl::emitFunctionDefinition(const ShaderNode& node, ShaderGenerator& shadergen, Shader& shader)
{
...
void CompoundNodeImpl::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderGenerator& shadergen, Shader& shader)
{
