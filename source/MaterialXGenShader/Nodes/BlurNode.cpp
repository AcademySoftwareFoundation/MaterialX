...
BEGIN_SHADER_STAGE(stage, MAIN_STAGE)
        ...
        emitInputSamplesUV(stage, node, context, shadergen, sampleStrings);
        ...
        if (_sampleCount > 1)
        {
            ...
            shadergen.emitLine(stage, _inputTypeString + " " + sampleName + "[" + MX_MAX_SAMPLE_COUNT_STRING + "]");
