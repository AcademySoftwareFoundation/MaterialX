...
string BlurNode::BOX_WEIGHT_FUNCTION = "sx_get_box_weights";
string BlurNode::GAUSSIAN_WEIGHT_FUNCTION = "sx_get_gaussian_weights";
...
void BlurNode::emitFunctionCall(const ShaderNode& node, GenContext& context, ShaderGenerator& shadergen, Shader& shader)
{
    ...
    {
        throw ExceptionShaderGenError("Node '" + node.getName() + "' is not a valid BlurNode node");
    }
