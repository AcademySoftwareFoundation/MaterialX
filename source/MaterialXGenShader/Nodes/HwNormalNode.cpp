...
void HwNormalNode::createVariables(const ShaderNode& node, GenContext& context, Shader& shader) const
{
    ...
    {
        addStageConnector(HW::VERTEX_DATA, Type::VECTOR3, context, HW::T_NORMAL_OBJECT, vs, ps);
    }
}
