...
#ifndef MATERIALXGENHW_NODES_HWTRANSFORMNODE_H
#define MATERIALXGENHW_NODES_HWTRANSFORMNODE_H
...
class MX_GENHW_API HwTransformNode : public ShaderNodeImpl
{
  public:
...
class MX_GENHW_API HwTransformVectorNode : public HwTransformNode
{
  public:
...
class MX_GENHW_API HwTransformPointNode : public HwTransformVectorNode
{
  public:
    static ShaderNodeImplPtr create();
...
class MX_GENHW_API HwTransformNormalNode : public HwTransformNode
{
  public:
    static ShaderNodeImplPtr create();
