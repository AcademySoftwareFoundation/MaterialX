...
void sx_complex_to_artistic_ior(vec3 ior, vec3 extinction, out vec3 reflectivity, out vec3 edgecolor)
{
    vec3 nm1 = ior - 1.0;
    vec3 np1 = ior + 1.0;
...
void sx_artistic_to_complex_ior(vec3 reflectivity, vec3 edgecolor, out vec3 ior, out vec3 extinction)
{
