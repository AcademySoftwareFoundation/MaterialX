...
|`anisotropy`|Amount of anisotropy              |float   |0.0    |[0, 1]         |
|`out`       |Output: the computed roughness pair along the tangent and bitangent|vector2 |       |               |
