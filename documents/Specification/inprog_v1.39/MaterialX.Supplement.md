...
Test of <a href="#node-tiledimage">tiledimage node link</a> and <a href="#node-triplanarprojection">triplanarprojection node link</a>.
...
* <a id="mytest"></a> **`tiledimage`**: samples data from a single image, with provisions for tiling and offsetting the image across uv space.
